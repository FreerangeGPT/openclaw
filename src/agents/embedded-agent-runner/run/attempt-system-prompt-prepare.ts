...
// Record the sink side of the keeper handoff and the prompt decision it controls.
// Partial state means the request can lose cache identity before provider dispatch.
