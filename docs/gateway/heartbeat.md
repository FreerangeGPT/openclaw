  ...
  agents: {
    defaults: {
      heartbeat: {
        ...
        consumeMemoryPrepend: true, // optional: let isolated runs consume queued associative recall
...
<ParamField path="consumeMemoryPrepend" type="boolean" default="true">
  Allows isolated heartbeat runs to claim queued associative-recall context. Set false to reserve that context for the next interactive turn.
</ParamField>
